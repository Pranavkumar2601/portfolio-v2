...
import React, { lazy, Suspense, FC, ReactNode, HTMLAttributes } from "react"; // Added FC, ReactNode, HTMLAttributes for mock components
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {certifications.map((cert, index) => (
              ...
              >
                <Card
                  className="border-2 backdrop-blur-sm transition-all duration-300 hover:shadow-xl h-full"
                  style={{
                    // Removed backgroundColor here
